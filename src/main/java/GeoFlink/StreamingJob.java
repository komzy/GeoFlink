	...
	public static void main(String[] args) throws Exception {
		...
		if (onCluster) {
			...
			if(args.length < 7)
			{
				...
				System.out.println("INPUT FORMAT FOR CLUSTER: --onCluster \"True\" --queryOption \"2\" --radius \"0.004\" --gridSize \"100\" --windowSize \"10\" --windowSlideStep \"5\" --k \"10\"");
				//--onCluster "True" --queryOption "2" --radius "0.004" --gridSize "100" --windowSize "10" --windowSlideStep "5" --k "10"
				System.exit(0);
			}
			...
			uniformGridSize = Integer.parseInt(parameters.get("gridSize"));
			windowSize = Integer.parseInt(parameters.get("windowSize"));
			windowSlideStep = Integer.parseInt(parameters.get("windowSlideStep"));
...
//			k = Integer.parseInt(args[6]);
		...
		//Control Tuple For Exit
		geoJSONStream.filter(new HelperClass.checkExitControlTuple()).name("Check For Control Tuple");
